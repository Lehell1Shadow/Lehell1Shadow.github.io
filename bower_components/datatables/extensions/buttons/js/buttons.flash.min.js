(function(g) {
    ...
    function A(a, b) {
        ...
        for (var e = 0, f = a.body.length; e < f && !(c = a.body[e][b].toString(),
        -1 !== c.indexOf("\n") ? (c = c.split("\n"),
        c.sort(function(a, b) {
            return b.length - a.length
        }),
        c = c[0].length) : c = c.length,
        c > d && (d = c),
        40 < d); e++)
            ;
        d *= 1.3;
    ...
    var x = function(a, b) {
      ...
      , y = function(a, b) {
        for (var d = b.newline ? b.newline : navigator.userAgent.match(/Windows/) ? "\r\n" : "\n", c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary, f = b.fieldSeparator, g = RegExp(e, "g"), h = b.escapeChar !== p ? b.escapeChar : "\\", k = function(a) {
            ...
            return b
        }, l = b.header ? k(c.header) + d : "", j = b.footer && c.footer ? d + k(c.footer) : "", m = [], u = 0, C = c.body.length; u < C; u++)
            m.push(k(c.body[u]));
        return {
            str: l + m.join(d) + j,
            rows: m.length
    ...
    i.ext.buttons.excelFlash = g.extend({}, t, {
        ...
        action: function(a, b, d, c) {
            var a = c._flash, e = 0, f = g.parseXML(o["xl/worksheets/sheet1.xml"]), h = f.getElementsByTagName("sheetData")[0], d = {
                _rels: {
            ...
            }, b = b.buttons.exportData(c.exportOptions), k, l, i = function(a) {
                k = e + 1;
                l = m(f, "row", {
                    attr: {
                        r: k
            ...
            g("row c", f).attr("s", "2"));
            for (var j = 0, n = b.body.length; j < n; j++)
                i(b.body[j], e);
